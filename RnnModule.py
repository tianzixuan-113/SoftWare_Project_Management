...
#change RnnModule.py -B3 -initial
...
class rnnModel(torch.nn.Module):
    def __init__(self, input_size, hidden_size, batch_size, num_layers):
        ...
        self.rnn =torch.nn.RNN(input_size=self.input_size,hidden_size=self.hidden_size,num_layers=num_layers,nonlinearity='relu',batch_first=True,dropout=0.5,bidirectional=True)
